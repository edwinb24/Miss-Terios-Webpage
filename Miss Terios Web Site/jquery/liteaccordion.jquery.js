...
;(function($) {
    ...
    var LiteAccordion = function(elem, options) {
        ...
        var defaults = {
            ...
            containerHeight : 330,                  // fixed (px)
            headerWidth : 29,                       // fixed (px)
            ...
            firstSlide : 9,                         // displays slide (n) on page load
            ...
            cycleSpeed : 99999999999999999999,                      // time between slide cycles
            easing : 'swing',                       // custom easing function
                                                    
            theme : 'dark',                        // basic, dark, light, or stitch
